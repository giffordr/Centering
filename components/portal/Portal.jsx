  ...
  return (
    <div className="Body"> 
      ...
      <p>
       ...
       <GameWeb/>
      <Typography variant="h5" align="center">Add this web app to your mobile device homescreen, by pressing the share icon <IosShareIcon/>, and selecting "Add to Homescreen".
